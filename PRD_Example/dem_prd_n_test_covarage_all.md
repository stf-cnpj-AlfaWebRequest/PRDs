...
4. Comparação com Coverage Existente

- Analise o arquivo:
  docs/code_coverage/index.html
...
- Destaque:
  ...
  - Cobertura superestimada ou subestimada

---

5. Geração do Documento Markdown
...
## 5. Comparison with Existing Coverage

- Resumo do index.html
...
Premissas:
_ Essa documentação precisa ter as seguintes seções:
...
_ Toda tabela necessita ter uma legenda explicando/descrevendo cada coluna.
_ Verificar se temos algo em inglês, pois tem de ser em português. Toda a documentação tem que ser em português, a menos que tenhamos algum termo técnico em inglês.
_ Teremos 2 casos de uso, para realizar a mudança do CNPJ de numérico para alfanumerico:
...
_ Para essa documentação, não faremos a seção de Resumo Executivo.
...
_ Não pode alterar módulos externos (DAF, HLP, etc).
_ Não pode pegar a Chave nem o Valor dos módulos que sejam principais.
_ VIPP4365.cbl = Considere esse arquivo sendo como chave (ID), ou seja, o campo do CNPJ seria apenas um identificador (chave estrangeira, fk), (Chave).
_ VIPP4553.cbl = Considere esse arquivo como se fosse um caso de valor do CNPJ (Valor). \* Funções para obter/validar o CNPJ:
